      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 h-fit sticky top-8">
          ...
          <div className="space-y-3 text-sm">
            ...
            {/* Discount Code - Highlighted Section */}
            <div className="border-t pt-4 mt-4">
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-dashed border-green-300 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                  </svg>
                  <label className="text-sm font-semibold text-green-700">{t.discountCode}</label>
                </div>
                <div className="flex gap-2">
                  <input
                    type="text"
                    className="flex-1 px-3 py-2 border-2 border-green-200 rounded-md text-sm focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all uppercase"
                    value={discountCode}
                ...
                {appliedDiscount && (
                  <div className="flex items-center gap-2 mt-2 text-green-700 bg-green-100 px-3 py-2 rounded-md">
